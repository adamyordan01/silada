@extends('layouts.base', ["title" => "Daftar Arsip Akta Pembagian Hak Bersama"])
...
@section('section-header')
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item">Daftar Arsip Akta Pembagian Hak Bersama</div>
    </div>
@endsection
